...
class CBORScannerTests : TestState, std::source_location {
  ...
  auto expect(std::source_location loc, Assessor assess,
              byte_vector from) noexcept try {
  ...
  inline auto expect_bstrx(std::source_location loc,
                           byte_vector from) noexcept {
...
public:
  ...
  auto test_decode_bstr0_with_payload() noexcept {
    auto test_vector = byte_vector{
        0x57, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
        0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17};
    auto expected = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
                     0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10,
                     0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17};
    return expect_bstr(current(), {std::from_range, expected | to_bytes},
                       test_vector);
  }

  auto test_decode_bstr1_with_payload() noexcept {
    auto test_vector =
        byte_vector{0x58, 0x17, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
  ...
  auto test_decode_bstr2_with_payload() noexcept {
    auto test_vector =
        byte_vector{0x59, 0x00, 0x17, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06,
  ...
  auto test_decode_bstr4_with_payload() noexcept {
    auto test_vector =
        byte_vector{0x5a, 0x00, 0x00, 0x00, 0x17, 0x01, 0x02, 0x03, 0x04, 0x05,
  ...
  auto test_decode_bstr8_with_payload() noexcept {
    auto test_vector = byte_vector{
        0x5b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x17, 0x01, 0x02,
